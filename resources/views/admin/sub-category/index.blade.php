...
@section('btn')
    <a href="{{ route('subCategory.create') }}" class=" btn btn-dribbble">
        Add Sub Category
    </a>
@endsection
@section('content')
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            @foreach ($subCategories as $key => $subCategory)
                                                <tr>
                                                    <td>
                                                        {{ ($subCategories->currentPage() - 1) * 10 + $key + 1 }}
                                                    </td>
                                                    <td>
                                                        {{ $subCategory->name }}
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span
                                                            class="text-secondary text-xs font-weight-bold">{{ $subCategory->created_at->format('d-m-Y') }}</span>
                                                    </td>
