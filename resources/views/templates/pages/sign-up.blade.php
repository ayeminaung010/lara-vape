                            ...
                            <form action="#" method="#">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="" class=" form-control rounded-0 py-3" id="">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class=" form-control rounded-0 py-3"
                                    ...
                                    <button class=" btn btn-dark text-uppercase rounded-0 py-3">Create An Account</button>
                                </div>
                            </form>
